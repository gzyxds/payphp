...
### 云端价格
::: danger 云端价格
为什么要收这个费用？因为没有这个费用,用户饱和之后官方没有收入来源供不起云端服务器,最后关站,明白？你暂时用不上 你可以不续费,但是别比比那么多,不爱用就换其他系统
:::

| 服务类型 | 月付 | 季度 | 半年 | 一年 | 永久 |
| ------------- | --------------- | --------------- | --------------- | --------------- | --------------- |
| 云端会员 | 10元 | 28元 | 50元 | 90元 | - |
| PC微信免输续费 | 30元 | 80元 | 150元 | 280元 | - |
| 自建IPad云端 | - | - | - | - | 299元 |
| 官方ipad云端 | 49元 | 140元 | 270元 | 538元 | - |
